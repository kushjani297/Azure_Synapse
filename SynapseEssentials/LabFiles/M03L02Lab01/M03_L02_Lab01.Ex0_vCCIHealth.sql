/*
  ===========================================
     Create Rowgroup Health View - Summary
  ===========================================
  This query will create a view that contains a Summary of the CCI Health
  
*/

If object_id('vCCIHealth') IS NOT NULL DROP VIEW vCCIHealth 
GO
