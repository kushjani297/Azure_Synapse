...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-facttransaction.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
	,MAXERRORS = 0
	,FIELDQUOTE = '"'
	,FIELDTERMINATOR = '|'
	,FIRSTROW = 2
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-factstockholding.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-factsale.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-factpurchase.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-factorder.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-factmovement.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-dimtransactiontype.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-dimsupplier.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-dimstockitem.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-dimpaymentmethod.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-dimemployee.csv'
WITH
(
	FILE_TYPE = 'CSV'
   -- 	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-dimdate.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-dimcity.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/wwi-dimcustomer.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/postalcodes.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
...
FROM 'https://jdsynstorage.dfs.core.windows.net/rawdata/WWI/EmployeePIIData20K.csv'
WITH
(
	FILE_TYPE = 'CSV'
    --	,CREDENTIAL=(IDENTITY= 'Shared Access Signature', SECRET='?sv=2020-10-02&ss=btqf&srt=sco&st=2022-02-24T01%3A15%3A31Z&se=2022-02-26T03%3A15%3A00Z&sp=rwdxftlacup&sig=ynzuXjY2Ohl%2FhubS4Ih')
